...
void loop() {
  ...
  if (Serial.available()) {
    ...
    serial1.print("Received from Serial: ");
    serial1.println(line);
  }

  // Read data from Serial2 and echo it to the main serial port
  ...
  // Read data from Serial3 and echo it to the main serial port
